        ...
        <main class="archive-content">
            <?php if (empty($s)) : ?>
                ...
                <div style="max-width: 600px; margin: 40px auto; padding: 40px; text-align: center;">
                    <div style="display: inline-flex; align-items: center; justify-content: center; width: 64px; height: 64px; background: rgba(231, 67, 74, 0.1); border: 1px solid rgba(231, 67, 74, 0.2); border-radius: 50%; color: var(--accent-red); margin-bottom: 24px;">
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="11" cy="11" r="8"></circle>
                            <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
                        </svg>
                    </div>
                    <h2 style="font-size: 24px; font-weight: 700; color: #333333; margin-bottom: 12px;">Explore Database</h2>
            ...
            <?php elseif ($total_results === 0) : ?>
                ...
                <div style="max-width: 600px; margin: 40px auto; padding: 40px; text-align: center;">
                    ...
                    <h2 style="font-size: 24px; font-weight: 700; color: #333333; margin-bottom: 12px;">No results found</h2>
                    <p style="color: var(--text-secondary); font-size: 15px; margin-bottom: 24px; line-height: 1.6;">
                        We couldn't find any videos matching &ldquo;<span style="color: var(--accent-red); font-weight: 600;"><?php echo esc_html($s); ?></span>&rdquo;.
                    </p>
                    <div style="background: #fdfdfd; border-radius: 12px; padding: 24px; text-align: left; border: 1px solid #eeeeee;">
                        <h3 style="font-size: 14px; font-weight: 700; color: #333333; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 12px;">Search Tips</h3>
            ...
            <?php else : ?>
                ...
                <div style="margin-bottom: 30px; font-size: 14px; color: var(--text-secondary); display: flex; align-items: center; gap: 8px;">
                    ...
                    <span style="color: var(--accent-red); font-weight: 600; padding: 2px 8px; background: rgba(231, 67, 74, 0.05); border: 1px solid rgba(231, 67, 74, 0.15); border-radius: 6px;">&ldquo;<?php echo esc_html($s); ?>&rdquo;</span>
