...
$wp_load_paths = [
    'C:/xampp/htdocs/69tube/wp-load.php',
    dirname(__DIR__) . '/69tube/wp-load.php', // Local sibling folder
    dirname(__DIR__) . '/wp-load.php',          // Subdomain root (Hostinger nested folder)
    $_SERVER['DOCUMENT_ROOT'] . '/wp-load.php', // Server document root
    $_SERVER['DOCUMENT_ROOT'] . '/69tube/wp-load.php'
];
...
// Base URL
if (!defined('BASE_URL')) {
    define('BASE_URL', '/69tube/admin-panel');
}
?>
