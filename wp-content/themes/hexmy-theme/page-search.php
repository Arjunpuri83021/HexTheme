        ...
        <main class="archive-content">
            <?php if (empty($s)) : ?>
                ...
                <div style="max-width: 600px; margin: 40px auto; padding: 40px; text-align: center;">
                    <div style="display: inline-flex; align-items: center; justify-content: center; width: 64px; height: 64px; background: rgba(247, 0, 35, 0.1); border: 1px solid rgba(247, 0, 35, 0.2); border-radius: 50%; color: var(--accent-color); margin-bottom: 24px;">
            ...
            <?php else : ?>
                ...
                <div style="margin-bottom: 30px; font-size: 14px; color: var(--text-secondary); display: flex; align-items: center; gap: 8px;">
                    ...
                    <span style="color: var(--accent-color); font-weight: 600; padding: 2px 8px; background: rgba(247, 0, 35, 0.08); border: 1px solid rgba(247, 0, 35, 0.2); border-radius: 6px;">&ldquo;<?php echo esc_html($s); ?>&rdquo;</span>
