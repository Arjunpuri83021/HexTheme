...
<head>
    ...
    <title>69Tube Admin — Login</title>
...
<body class="login-body">
    <div class="login-container">
        ...
        <div class="login-logo">
            <div class="login-logo-mark" style="background: var(--accent-color);">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>
            </div>
            <div class="login-logo-wordmark"><span class="vip" style="color: var(--accent-color);">69</span><span class="fourk">Tube</span></div>
