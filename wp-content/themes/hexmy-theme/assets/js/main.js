...
document.addEventListener('DOMContentLoaded', function() {
    ...
    navLinks.forEach(link => {
        if (link.href && currentUrl.includes(link.href) && link.getAttribute('href') !== '#') {
            const isHome = link.href === window.location.origin + '/' || link.href === window.location.origin + '/wordpress/' || link.href === window.location.origin + '/vip4kPorn/';
            if (isHome) {
                if (window.location.pathname === '/' || window.location.pathname === '/wordpress' || window.location.pathname === '/wordpress/' || window.location.pathname === '/vip4kPorn' || window.location.pathname === '/vip4kPorn/') {
